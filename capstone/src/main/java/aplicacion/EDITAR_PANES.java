...
private IngredientesTableModel ingredientesModel = new IngredientesTableModel();
    ...
    // (opcional) puedes agregar editores específicos más adelante
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EDITAR_PANES.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

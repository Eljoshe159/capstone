...
public class INICIO_TORTAS extends javax.swing.JFrame {

    private final RecipeDao recipeDao = new RecipeDao();
    public INICIO_TORTAS() {
        initComponents();
    ...
    private void cargarNombres(String filtro) {
        try {
            List<String> nombres = recipeDao.listarNombresPorCategoria("TORTAS", filtro);

            DefaultTableModel model = new DefaultTableModel(new Object[]{"Receta"}, 0) {
            ...
            javax.swing.JOptionPane.showMessageDialog(
                this, "Error cargando tortas: " + ex.getMessage(),
    ...
    try {
        Integer id = recipeDao.buscarIdPorCategoriaYNombre("TORTAS", nombre);
        if (id == null) {
            javax.swing.JOptionPane.showMessageDialog(this, "No se encontró la receta.", "Aviso",
                    javax.swing.JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        new EDITAR_TORTAS(id).setVisible(true);
        dispose();
    } catch (Exception ex) {
    ...
    int ok = javax.swing.JOptionPane.showConfirmDialog(
        this,
        "¿Borrar la receta \"" + nombre + "\" de TORTAS?",
        "Confirmar borrado",
    ...
    try {
        boolean borrado = recipeDao.eliminarPorCategoriaYNombre("TORTAS", nombre);
        if (borrado) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(INICIO_TORTAS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
